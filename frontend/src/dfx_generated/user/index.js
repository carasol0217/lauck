...
export const canisterId = process.env.CANISTER_ID_USER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./user.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the user canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./user.did.js")._SERVICE>}
 */
